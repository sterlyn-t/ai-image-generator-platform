...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://ai-image-genrator-platform.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      setLoading(true);
      try {
        const response = await fetch('https://ai-image-genrator-platform.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        <div className='flex flex-col gap-5'>
          ...
          h-64 flex justify-center items-center'>
            ...
            {generatingImg && (
              ...
              justify-center items-center bg-[rbga(0, 0, 0, 0.5)]
              rounded-lg'>
                <Loader />
              </div>
            )
